      ...
      <div class="container">
        ...
        <!--Display errors -->
            ...
            <?php  unset($_SESSION['errors']); 
                ...
                <p style="color:red">Note: Password should be at least 8 characters in length and should include at least one upper case letter,one lowercase, one number, and one special character.</p>
            <?php }?>
        ...
        <br><input type="checkbox" checked="checked" name="OTP"> Always Send OTP When I Login
