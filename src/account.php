...
?>
    <section class="account">
        ...
        <a style="font-weight:bold">Email: </a>
            ...
            <a><?php echo  date('m/d/Y', strtotime($_SESSION['date_created']));?><br></a>

        <a href="logout.php" style="color: darkblue;">Logout</a>
        <form action="allowOTP.php" method="post"> 
            <?php 
            if($_SESSION['allowotp'] == 1){
                echo '<br>';
               echo '<input type="checkbox" checked="checked" name="alwaysOTP"> Always Send OTP When I Login';
               echo '<button type="submit" class="registerbtn" name="reg_user">Disallow Always OTP</button>';
            }else if($_SESSION['allowotp'] == 0){ 
                echo '<br>';
                echo '<input type="checkbox" name="neverOTP"> Always Send OTP When I Login';
                echo '<button type="submit" class="registerbtn" name="reg_user">Allow Always OTP</button>';
            }?>
